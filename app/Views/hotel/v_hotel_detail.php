                    ...
                    <?php if (!empty($reviews)): ?>
                        ...
                        <div class="review mb-4 pb-4 border-bottom">
                            <div class="d-flex align-items-center mb-3">
                                <img src="<?= (!empty($review['photo']) && $review['photo'] !== 'default.jpg') ? base_url('uploads/profiles/'.$review['photo']) : base_url('/dummy/person.png') ?>" class="rounded-circle me-3" width="50" height="50" alt="<?= esc($review['full_name']) ?>">
                                <div>
